...
const CompareCar = ({ navigation }: any) => {
  ...
  const handleFeatures = () => {
    ...
    //newFeatures= uniqueArray;

    //console.log("uniqueArray", uniqueArray);

    let result: any = uniqueArray.map((key) => 100);

    //newFeatureWidth = result
  ...
  const Features = () => {
    ...
    console.log("new featuelist", newFeaturelist);
    console.log("newFeatureWidth", newFeatureWidth);
    return (
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.tableContainer}>
          {/* Left Column */}
              ...
              <View>
                ...
                >
                  <Table borderStyle={{ borderWidth: 1, borderColor }}>
                    ...
                    {/* {shortListCars.map((rowData: any, index: any) => (
